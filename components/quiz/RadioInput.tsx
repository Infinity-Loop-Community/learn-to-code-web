...
export default function RadioInput(props: { field?: ControllerRenderProps, name?: string, value: string, checked: boolean, readOnly: boolean, labelElement: ReactElement }) {
    ...
    <label htmlFor={props.value}>
      <div className="radio d-flex align-items-center justify-center">
        ...
        <input type="radio"  {...props.field} value={props.value}
               checked={props.readOnly ? props.checked : undefined} readOnly={props.readOnly}/>
