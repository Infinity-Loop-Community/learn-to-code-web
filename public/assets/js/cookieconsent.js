/******/ (() => {
        ...
        value: function listGlobalServices(category) {
          ...
          if (typeof category === "undefined") {
            ...
            for (var _key in window.CookieConsent.config.services) {
              if (
                window.CookieConsent.config.services[_key].category === category
              )
  ...
  function InsertScriptFilter_createClass(
    Constructor,
    protoProps,
    staticProps
  ) {
  ...
  function ScriptTagFilter_possibleConstructorReturn(self, call) {
    if (
      call &&
      (ScriptTagFilter_typeof(call) === "object" || typeof call === "function")
    ) {
      return call;
    } else if (call !== void 0) {
      throw new TypeError(
      ...
      },
      {
        ...
        value: function filterTags() {
          ...
          Utilities.ready(function () {
            var blacklist = _get(
              ScriptTagFilter_getPrototypeOf(ScriptTagFilter.prototype),
              "createBlacklist",
              _this
  ...
  function WrapperFilter_possibleConstructorReturn(self, call) {
    if (
      call &&
      (WrapperFilter_typeof(call) === "object" || typeof call === "function")
    ) {
      return call;
    } else if (call !== void 0) {
      throw new TypeError(
    ...
    WrapperFilter_createClass(WrapperFilter, [
      ...
      },
      {
        ...
        value: function filterWrappers() {
          var blacklist = WrapperFilter_get(
            WrapperFilter_getPrototypeOf(WrapperFilter.prototype),
            "createBlacklist",
            this
          ).call(this, "wrapped");
  ...
  function LocalCookieFilter_createSuper(Derived) {
    var hasNativeReflectConstruct =
      LocalCookieFilter_isNativeReflectConstruct();
    return function _createSuperInternal() {
  ...
  function LocalCookieFilter_possibleConstructorReturn(self, call) {
    if (
      call &&
      (LocalCookieFilter_typeof(call) === "object" ||
    ...
    LocalCookieFilter_createClass(LocalCookieFilter, [
      ...
      },
      {
        ...
        value: function filterlocalCookies() {
          ...
          var blacklist = LocalCookieFilter_get(
            LocalCookieFilter_getPrototypeOf(LocalCookieFilter.prototype),
            "createBlacklist",
            this
  ...
  function Interface_createForOfIteratorHelper(o, allowArrayLike) {
    ...
    if (!it) {
      if (
        Array.isArray(o) ||
        (it = Interface_unsupportedIterableToArray(o)) ||
        (allowArrayLike && o && typeof o.length === "number")
      ) {
        if (it) o = it;
        var i = 0;
    ...
    Interface_createClass(Interface, [
        ...
        value: function buildStyle() {
          return el(
            ...
            "#cconsent-bar button { line-height:normal; font-size:14px; border:0; padding:10px 10px; color:" +
              ...
              ";}",
            "#cconsent-bar button.consent-give { line-height:normal; font-size:14px; border:none; padding:10px 10px; color:" +
              window.CookieConsent.config.theme.barMainButtonTextColor +
              "; background-color:" +
              window.CookieConsent.config.theme.barMainButtonColor +
              ";}",
            "#cconsent-bar button.consent-decline { line-height:normal; font-size:14px; border:none; padding:10px 10px; color:" +
              window.CookieConsent.config.theme.barMainButtonColor +
              "; background-color:" +
              window.CookieConsent.config.theme.barMainButtonTextColor +
            ...
            "#cconsent-modal .ccm__content > .ccm__content__heading .ccm__cheading__close:focus-visible { box-shadow: 0 0 0 0.25rem " +
              window.CookieConsent.config.theme.focusColor +
              "; }",
            ...
            "#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__tab-content__choose .ccm__switch-group:focus-visible {box-shadow: 0 0 0 2px" +
              window.CookieConsent.config.theme.focusColor +
              ";}",
                ...
                el(
                  ...
                  el(
                    ...
                    el(
                      ...
                      el(
                        "span.ccm__tab-head__status" +
                          (window.CookieConsent.config.categories[key].checked
                            ? ".ccm__tab-head__status--checked"
                            : ".ccm__tab-head__status--unchecked"),
                        window.CookieConsent.config.categories[key].checked
                          ? "✔"
                          : "×",
                        {
                          "aria-label": window.CookieConsent.config.categories[
                            key
                          ].checked
                            ? Language.getTranslation(
                                window.CookieConsent.config,
                  ...
                  el(
                    ...
                    el(
                      ...
                      el(
                        ...
                        el(
                          "h3#ccm__tab-content__title--" + tabId,
                          Language.getTranslation(
                            window.CookieConsent.config.categories[key],
                            window.CookieConsent.config.language.current,
                            "name"
                      ...
                      el(
                        ...
                        !window.CookieConsent.config.categories[key].needed &&
                          el(
                            ...
                            el(
                              "span.ccm__switch__status.status-off",
                              Language.getTranslation(
                                window.CookieConsent.config,
                                window.CookieConsent.config.language.current,
                                "off"
                            ...
                            el(
                              ...
                              el(
                                "span.ccm__switch__text.visually-hide",
                                Language.getTranslation(
                                  window.CookieConsent.config.categories[key],
                                  window.CookieConsent.config.language.current,
                                  "name"
                            ...
                            el(
                              "span.ccm__switch__status.status-on",
                              Language.getTranslation(
                                window.CookieConsent.config,
                                window.CookieConsent.config.language.current,
                                "on"
          ...
          return el(
            ...
            el(
              ...
              el(
                ...
                el("div.ccm__tabs", modalTabGroups())
              ),
              el(
                "div.ccm__footer",
                el(
        ...
        value: function modalRedrawIcons() {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done; ) {
              ...
              var lightSwitch = tabGroup.querySelector(
                "button.ccm__switch-group"
              );
      ...
      },
      {
        ...
        value: function addEventListeners(elements) {
          ...
          var _iterator2 =
              Interface_createForOfIteratorHelper(buttonConsentGive),
            _step2;
          ...
          var _iterator3 =
              Interface_createForOfIteratorHelper(buttonConsentDecline),
            _step3;
          ...
          this.elements["modal"]
            ...
            .addEventListener("click", function (event) {
              // If you click trough the tabs on Cookie settings
              if (
                event.target.classList.contains("ccm__tab-trigger") ||
                ...
                if (parentDl.classList.contains("ccm__tabgroup--open")) {
                  ...
                  parentDl
                    .querySelector(".ccm__tab-content")
              ...
              if (event.target.classList.contains("ccm__switch-group")) {
                ...
                var dlStatus = document.querySelector(
                  ".ccm__tabgroup." +
                    event.target.dataset.category +
                    " .ccm__tab-head__status"
                );
                window.CookieConsent.config.categories[
                  event.target.dataset.category
          ...
          document
            ...
            .addEventListener("click", function () {
              var switchElements =
                _this.elements["modal"].querySelectorAll(".ccm__switch input");
      ...
      },
      {
        ...
        value: function writeBufferToDOM() {
          var _iterator4 = Interface_createForOfIteratorHelper(
    ...
    Configuration_createClass(Configuration, [
      ...
      },
      {
        ...
        value: function isObject(item) {
          return (
            item &&
            Configuration_typeof(item) === "object" &&
            !Array.isArray(item)
          );
      ...
      },
      {
        ...
        value: function removeUnwantedCookies() {
          ...
          for (var service in config.services) {
            if (
              Utilities.objectType(config.services[service].cookies) === "Array"
            ) {
              // Remove cookies if they are not wanted by user
              if (
                !config.categories[config.services[service].category].wanted
              ) {
                for (var i in config.services[service].cookies) {
                  var type = Utilities.objectType(
        ...
        value: function removeCookie(cookie) {
          ...
          var domain =
            Utilities.objectType(cookie.domain) === "String"
              ...
              : "";
          document.cookie = ""
            .concat(cookie.name, "=; expires=Thu, 01 Jan 1980 00:00:00 UTC; ")
            .concat(domain, " path=/;");
        },
      },
    ]);
